...
<br>
Mainstream policy discourse about access  
- "Achievement gap", "under-matching"; place responsibility on students, K-12 schools
- Universities pledge commitment via policies (e.g., need-based financial aid, "outreach", holistic admission)
...
<br>
Geography of Opportunity `r cite(bib['RN6067'])`
-Educational opportunities are a function of where students live 
-Number of local colleges and universities spatially varies along the racial and socioeconomic characteristics of neighborhoods `r cite(bib['RN6064'])`
-Shifts onus of access inequality away from students and K-12 schools; but students' college choices are also shaped by choices of colleges and universities `r cite(bib['RN6068'])`
