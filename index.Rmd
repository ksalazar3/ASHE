...
Racial inequality is grounded in the governing of space and its impact on where People of Color live `r citep(bib[c('RN2038')])`
  - Forced migration of indigenous people and seizure of their ancestral lands
  - Plessy v. Ferguson 
  - Policies and court decisions abetted "de facto" segregation after Brown v. Board of Education `r citep(bib[c('RN2547')])`
  - Federal and state regulatory tolerance of "reverse redlining" (i.e., predatory lending) `r citep(bib[c('RN5070')])`
...
Racial inequality in access to higher education is grounded in the governing of (admissions) space(s)
  - HBCUs
  - Out-of-state tuition and non-resident enrollment caps to prevent the integration of Black graduate students `r citep(bib[c('RN6007')])`
  - Culturally and socioeconomically biased admissions metrics (e.g., SAT/ACT) `r cite(bib[c('RN6012', 'RN6011')])`

<br>  

Students' college opportunities are also shaped by the choices of universities `r citep(bib[c('RN6068')])`
