...
<ul>
  ...
  <li>University of Colorado-Boulder
    <ul>
      <li><a href="#/`r verticalSlide2`/2">Figures</a></li>
      <li><a href="#/`r verticalSlide2`/3">Map</a></li>
    </ul>
  </li>
  <li>University of Massachusetts-Amherst
    <ul>
      <li><a href="#/`r verticalSlide2`/4">Figures</a></li>
...
<ul>
  <li><a href="#/`r verticalSlide2`/6">MSA Overview</a></li>
  <li>University of Kansas
    <ul>
      <li><a href="#/`r verticalSlide2`/7">Figures</a></li>
      <li><a href="#/`r verticalSlide2`/8">Map</a></li>
    </ul>
  </li>
